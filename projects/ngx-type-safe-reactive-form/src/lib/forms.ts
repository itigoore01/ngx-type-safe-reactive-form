...
export type CreateFormType<TConfig> =
  ...
  TConfig extends TypedFormGroup<infer TControls, infer TValue> ? TypedFormGroup<TControls, TValue> :
  TConfig extends TypedFormArray<infer TControl, infer TValue> ? TypedFormArray<TControl, TValue> :
