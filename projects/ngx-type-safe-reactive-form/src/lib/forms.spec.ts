import { TypeSafeFormBuilder } from './forms';
...
describe('Form Builder', () => {
  ...
  beforeEach(() => {
    b = TestBed.get(TypeSafeFormBuilder);
  });

  it('should create controls from a value', () => {
    const g = b.group({ login: 'some value' });

    expect<string>(g.controls.login.value).toEqual('some value');
  });
  ...
  it('should create controls from a boxed value', () => {
    ...
    expect<string>(g.controls.login.value).toEqual('some value');
    expect<boolean>(g.controls.login.disabled).toEqual(true);
  });
  ...
  it('should create controls from an array', () => {
    ...
    expect<string>(g.controls.login.value).toEqual('some value');
    expect<string>(g.controls.password.value).toEqual('some value');
  ...
  it('should support controls with no validators and whose form state is null', () => {
    ...
    expect<null>(g.controls.login.value).toBeNull();
  ...
  it('should support controls with no validators and whose form state is undefined', () => {
    ...
    expect<undefined>(g.controls.login.value).toBeNull();
    expect(g.controls.login.validator).toBeNull();
    expect(g.controls.login.asyncValidator).toBeNull();
  });
  ...
  it('should create groups with a custom validator', () => {
    const g = b.group(
      { login: 'some value' }, { validator: syncValidator, asyncValidator });

    expect<string>(g.controls.login.value).toBe('some value');
  ...
  it('should create control arrays', () => {
    ...
    expect<Array<string | string[] | null | undefined>>(a.value).toEqual(['one', 'two', 'three', ['four'], null, null]);
  ...
  it('should create control arrays with multiple async validators', fakeAsync(() => {
    ...
    expect<string[]>(a.value).toEqual(['one', 'two']);
